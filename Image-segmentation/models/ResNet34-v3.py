...
def ResNet34UNetV3(input_shape, num_classes):
    ...
    # Decode
    y4 = DecoderV3(64)(layers.Concatenate(axis=3)([x4, y5]))
    y3 = DecoderV3(64)(layers.Concatenate(axis=3)([x3, y4]))
    y2 = DecoderV3(64)(layers.Concatenate(axis=3)([x2, y3]))
    y1 = DecoderV3(64)(layers.Concatenate(axis=3)([x1, y2]))
    y0 = DecoderV3(64)(y1)
