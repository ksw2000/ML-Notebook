...
def SKNet50UNetV2(input_shape, num_classes):
    ...
    # SKNet50
    x1 = Encoder(filters=128, strides=1, repeat=3)(CBAM(reduction=16)(x0))
    x2 = Encoder(filters=256, strides=2, repeat=4)(CBAM(reduction=16)(x1))
    x3 = Encoder(filters=512, strides=2, repeat=6)(CBAM(reduction=16)(x2))
    x4 = Encoder(filters=1024, strides=2, repeat=5)(CBAM(reduction=16)(x3))
